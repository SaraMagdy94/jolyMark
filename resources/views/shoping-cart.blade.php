                            ...
                            <tbody>
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="../jolyfrontend/img/bag/7.jpg" alt="">
                                        <h5>جزمه</h5>
                                    </td>
                                ...
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="../jolyfrontend/img/bag/6.jpg" alt="">
                                        <h5>كوتشي</h5>
                                    </td>
                                    <td class="shoping__cart__price">
                                    ٣٠ريال 
                                ...
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="../jolyfrontend/img/bag/14.jpg" alt="">
                                        <h5>شنطه</h5>
                                    </td>
                                    <td class="shoping__cart__price">
                                    ٧٠ريال 
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <a href="{{url('/')}}" class="primary-btn cart-btn">متابعه الشراء</a>
